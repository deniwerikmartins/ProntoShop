...
public class CheckoutApapter extends RecyclerView.Adapter<CheckoutApapter.ViewHolder> {

    private final List<LineItem> mLineItems;
    private Activity mContext;
    private final CartActionsListener mListener;

    public CheckoutApapter(List<LineItem> mLineItems, Context context, CartActionsListener mListener) {
